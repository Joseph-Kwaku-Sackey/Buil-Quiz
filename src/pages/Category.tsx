...
const Category = () => {
	...
	const handleScroll = () => {
		categoryContainerRef.current!.classList.add("category-scroll");
		const timeoutId = setTimeout(() => {
			categoryContainerRef.current?.classList.remove("category-scroll");
	...
	return (
		<section className=" select-none relative text-left ">
			<section className="flex flex-col items-center">
				...
				<section
					className=" h-[350px] category-container mt-10 flex px-8 py-4 justify-center w-[90%] overflow-y-scroll"
